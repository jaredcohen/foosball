	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="create" params="['result.id': gameInstance?.result?.id, 'sessionId': gameInstance?.result?.sessionId]">${message(code: 'default.add.label', args: [message(code: 'game.label', default: 'Game')])}</g:link></li>
			</ul>
		</div>
