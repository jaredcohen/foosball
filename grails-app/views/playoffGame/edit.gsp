...
<html>
	...
	<body>
		<a href="#edit-playoffGame" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-playoffGame" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${playoffGameInstance?.version}" />
				<fieldset class="form">
